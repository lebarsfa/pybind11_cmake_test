...
if [ $_PYTHON_HOST_PLATFORM = "macosx-11.0-arm64" ]; then
 cmake -E env CXXFLAGS="-fPIC" CFLAGS="-fPIC" cmake -D CMAKE_SYSTEM_NAME=Darwin -D CMAKE_OSX_ARCHITECTURES=arm64 -D CMAKE_INSTALL_PREFIX=~/arm-target -D INTERVAL_LIB=filib ..
fi
